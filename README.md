...
- `CNF_Formula` - struct - formula holds all the clauses in the formula.
...
- `DLIS` - function - hols the DLIS heuristic. Returns the literal that appears most often in unsatisfied clauses.
...
- `simple_test_runner.sh` - runs 6 claude generated CNF benchmakrs to test the simple DPLL algorithm.
